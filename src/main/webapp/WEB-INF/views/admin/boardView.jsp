...
<div id="boardTB">
   <div class="col-1">
      <h2 align="center" style="margin-bottom: 20px;">${boardDTO.bno }. 공지사항</h2>
      <form method="post">
         <table>
            <thead>
               <tr align="center">
         ...
         <div class="modal_content">
            ...
            <div class="replyContent">
               <div style="margin-right: 20px; margin-bottom: 20px;" align="left">
                  ...
                  <input id="modalWriter" type="text" readonly="readonly" style="pointer-events: none;" title="작성자는 수정이 불가능합니다">
                  <br>
                  <br>
                  <!-- 비밀번호 -->
                  <label title="작성자는 수정이 불가능합니다">비밀번호 : </label>
            ...
            <div class="modal-config-btn" align="right">
